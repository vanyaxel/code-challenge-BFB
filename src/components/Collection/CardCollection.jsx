	...
	return (
		<Grid container justify="space-between" className={classes.cardContainer}>
			{collection.map((release) => (
				<Grid key={uuid4()} item container justify="space-between" sm={12} md={6}>
					<Card className={classes.cardCollection} variant="outlined" >
						<CardContent>
							<table>
								<tbody>
									<tr>
									...
									<tr>
										...
										<td>
											<Typography className={classes.textInfo} color="secondary">
												{bull}
												{release.basic_information.genres.map((genre) => (
